    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="dashboard-box margin-top-0">
                ...
                <!-- Headline -->
                <div class="headline">
                    <h3><i class="icon-feather-folder-plus"></i> Project Edit Form</h3>
                </div>
                <form method="POST" action="/project/{{$Project->id}}" id="project-form">
                    @csrf
                    @if ($errors->any())
                            ...
                            <div class="col-xl-4">
                                <div class="submit-field">
                                    ...
                                    <div class="input-with-icon">
                                        <input class="with-border" type="text" value="{{$Project->budget}}"
                                               name="budget"
                                               id="budget"
                                               placeholder="e.g. 75$">
                                ...
                                <div class="submit-field">
                                    ...
                                    <div class="">
                                        <div id="autocomplete-container">
                                            <input id="deadline" name="deadline" value="{{$Project->deadline}}"
                                                   class="with-border"
                                                   type="date">
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-8">
                                <div class="submit-field">
                                    ...
                                    <textarea cols="30" name="details" id="details" rows="5"
                                              class="with-border">{{$Project->details}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
