                    ...
                    <div class="sidebar-widget">
                        <div class="bidding-widget">
                            ...
                            <form action="post" class="bidding-inner">
                                ...
                                <input class="bidding-slider" type="text" value="price" id="price" name="price" data-slider-handle="custom" data-slider-currency="$" data-slider-min="2500" data-slider-max="4500" data-slider-value="auto" data-slider-step="50" data-slider-tooltip="hide" />
