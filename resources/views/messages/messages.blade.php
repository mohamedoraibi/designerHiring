            ...
            <div class="messages-inbox">
                ...
                <ul>
                    <li>
                        <a href="#">
                            <div class="message-avatar"><i class="status-icon status-online"></i><img
                                    src="/newStyle/images/user-avatar-small-03.jpg" alt=""/></div>
                    ...
                    <li class="active-message">
                        <a href="#">
                            <div class="message-avatar"><i class="status-icon status-offline"></i><img
                                    src="/newStyle/images/user-avatar-small-02.jpg" alt=""/></div>
                    ...
                    <li>
                        <a href="#">
                            <div class="message-avatar"><i class="status-icon status-offline"></i><img
                                    src="/newStyle/images/user-avatar-placeholder.png" alt=""/></div>
                ...
                <div class="message-content-inner">
                    ...
                    <div class="message-bubble me">
                        <div class="message-bubble-inner">
                            <div class="message-avatar"><img src="/newStyle/images/user-avatar-small-01.jpg" alt=""/>
                            </div>
                            <div class="message-text"><p>Thanks for choosing my offer. I will start working on
                                    your project tomorrow.</p></div>
                        </div>
                    ...
                    <div class="message-bubble">
                        <div class="message-bubble-inner">
                            <div class="message-avatar"><img src="/newStyle/images/user-avatar-small-02.jpg" alt=""/>
                            </div>
                    ...
                    <div class="message-bubble">
                        <div class="message-bubble-inner">
                            ...
                            <div class="message-text"><p>Hi Tom! Hate to break it to you, but I'm actually on
                                    vacation 🌴 until Sunday so I can't check it now. 😎</p></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="message-bubble me">
                        <div class="message-bubble-inner">
                            ...
                            <div class="message-text"><p>Ok, no problem. But don't forget about last payment.
                                    🙂</p></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
